    ...
    return (
        ...
        <ul className="list-disc list-inside flex flex-wrap flex-col">
           <li className="text-elem shrink-0 mt-0 text-left text-sm font-normal mt-1">
            ...
            <li className="text-elem shrink-0 mt-0 text-left text-sm font-normal mt-1">
                9-Month Full Stack Engineering Program offered by Liberty Mutual, Sika Education, and <Link text={"Kyle Coberly"} link={"https://kylecoberly.github.io/resume/"} />
            </li>
            <li className="text-elem shrink-0 mt-0 text-left text-sm font-normal mt-1">
                6-Month Data Engineering Program offered by Liberty Mutual, and PluralSight.
            </li>
        </ul>
    )
}
